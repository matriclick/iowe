...
set :application, "iowe"
role :app, 'ec2-54-205-144-132.compute-1.amazonaws.com'
role :web, 'ec2-54-205-144-132.compute-1.amazonaws.com'
set :user, 'ubuntu'
...
task :production do
  ...
  set :application, "iowe"
  server "ec2-54-205-144-132.compute-1.amazonaws.com", :app, :web, :db, :primary => true
  set :repository,  "git@github.com:matriclick/iowe.git"
  set :scm, "git"
